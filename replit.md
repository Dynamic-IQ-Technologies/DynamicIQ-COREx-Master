...
-   **Purchase Orders**: Supports multi-line procurement, supplier relationships, dynamic line item management, and partial/full receiving with integrated UOM conversion.
...
-   **AI Supplier Discovery**: AI-powered module (using OpenAI GPT-4o) to find potential suppliers for material requirements, generating ranked recommendations with confidence scores and an approval workflow.

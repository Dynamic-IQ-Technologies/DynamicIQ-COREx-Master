...
class PostgresConnection:
    ...
    def _translate_sqlite_to_postgres(self, query):
        ...
        # Note: Boolean columns in this system are stored as INTEGER (0/1), not BOOLEAN
        # so we do NOT translate is_active = 1 to is_active = TRUE
...
class Database:
    ...
    def seed_chart_of_accounts(self):
        """Seed chart of accounts - works for both SQLite and PostgreSQL"""
        conn = self.get_connection()
        ...
        # All accounts to insert (flat structure for PostgreSQL compatibility)
        # Parent references use NULL for simplicity in PostgreSQL
        all_accounts = [
            ('1000', 'Assets', 'Asset'),
            ...
            ('1140', 'WIP - Work in Process', 'Asset'),
            ('1150', 'Finished Goods Inventory', 'Asset'),
            ('1200', 'Fixed Assets', 'Asset'),
            ('1210', 'Equipment', 'Asset'),
            ('1220', 'Accumulated Depreciation', 'Asset'),
            ('2000', 'Liabilities', 'Liability'),
            ('2100', 'Current Liabilities', 'Liability'),
            ('2110', 'Accounts Payable', 'Liability'),
            ('2120', 'Accrued Expenses', 'Liability'),
            ('2130', 'Tax Payable', 'Liability'),
            ('2150', 'Wages Payable', 'Liability'),
            ('2200', 'Long-term Liabilities', 'Liability'),
            ('2210', 'Notes Payable', 'Liability'),
            ('3000', 'Equity', 'Equity'),
